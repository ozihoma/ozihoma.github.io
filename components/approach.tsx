...
export default function Approach() {
  ...
  const achievements = [
    {
      title: "Code Master",
      description: "Delivered 45+ projects",
      icon: "⚡",
      unlocked: true,
    },
    {
    ...
    },
    {
      ...
      description: "60+ FPS optimized apps",
      icon: "⚙️",
      unlocked: true,
    },
  ]
    ...
    <section id="approach" className="section-padding bg-[#0a0a0a]">
      <div className="section-container">
        ...
        <motion.div
          ...
          className="mt-20 pt-20 border-t border-[#549642]/20"
        >
          <h3 className="text-2xl md:text-3xl font-bold mb-12 text-center text-[#549642]">
