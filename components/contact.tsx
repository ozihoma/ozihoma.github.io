...
import Terminal3D from "./3d-terminal"
  ...
  return (
    <section id="contact" className="section-padding bg-[#0a0a0a]">
      <div className="section-container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-left text-[#549642]">
            Get In Touch
          </h2>
          <p className="text-gray-400 mb-12 font-mono text-sm">&gt; Initialize connection_sequence.js</p>
        </motion.div>
        ...
        >
          <Terminal3D
            lines={[
              "$ sudo connect --to henry.azubuike",
              ...
              "EMAIL: azubuikeho@gmail.com",
              "",
              "Ready to discuss your next project!",
            ]}
            title="CONTACT_INTERFACE [ v2.0 ]"
          />
        </motion.div>
